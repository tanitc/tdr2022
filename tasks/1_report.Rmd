...
#summary(lm(PES_DIF ~  B, data = p_td_tot %>% filter(MEDI != "0_Aire", SETMANA>=0) ))
model <- lm(PES_DIF ~  B*SETMANA, data = p_td_tot %>% filter(MEDI != "0_Aire", SETMANA>=0) )
summary(model)
#summary(lm(PES_DIF ~  B*M, data = p_td_tot %>% filter(MEDI != "0_Aire", SETMANA>=0) ))
